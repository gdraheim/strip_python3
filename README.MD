...
The pyi typehint include files are usually generated to be compatible for
`--pyi-version=3.6`. That requires the positionalonly syntax to be
removed in that file as well.
